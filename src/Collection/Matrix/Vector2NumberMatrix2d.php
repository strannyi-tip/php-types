...
/**
 * 2d matrix of Vector2Number`s.
 */
class Vector2NumberMatrix2d extends AbstractMatrix2d
{
    /**
     * @inheritDoc
     */
    #[Override]
    public function get(int $x, int $y): Vector2Number|string
    {
    ...
    public function set(int $x, int $y, mixed $value): AbstractMatrix2d
    {
        if (!$value instanceof Vector2Number) {
            throw new InvalidArgumentException('Support Vector2Number type only');
        }
