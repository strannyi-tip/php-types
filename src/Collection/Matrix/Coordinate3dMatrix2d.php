...
/**
 * 2d matrix of Coordinate3d`s.
 */
class Coordinate3dMatrix2d extends AbstractMatrix2d
{
    /**
     * @inheritDoc
     */
    #[Override]
    public function get(int $x, int $y): Coordinate3d|string
    {
    ...
    public function set(int $x, int $y, mixed $value): AbstractMatrix2d
    {
        if (!$value instanceof Coordinate3d) {
            throw new InvalidArgumentException('Support Coordinate3d type only');
        }
